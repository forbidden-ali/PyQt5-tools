...
def GHash323(has):
    hs='80000000'
    if len(has)==len(hs) and has.isdigit()==True and has.isalpha()==False and has.isalnum()==True:
        jerar.append("103040")
def GHash325(has):
    hs='85318985'
    if len(has)==len(hs) and has.isdigit()==True and has.isalpha()==False and has.isalnum()==True:
...
def DESUnix(has):
    hs='ZiY8YtDKXJwYQ'
    if len(has)==len(hs) and has.isdigit()==False and has.isalpha()==False:
        jerar.append("104020")
...
def DomainCachedCredentials(has):
...
def md5saltpass(has):
    ...
    if len(has)==len(hs) and has.isdigit()==False and has.isalpha()==False and has.isalnum()==True:
        jerar.append("106280")
def md5saltpasssalt(has):
    hs='469e9cdcaff745460595a7a386c4db0c'
    if len(has)==len(hs) and has.isdigit()==False and has.isalpha()==False and has.isalnum()==True:
        jerar.append("106300")
def md5saltpassusername(has):
...
def md5sha1pass(has):
    ...
    if len(has)==len(hs) and has.isdigit()==False and has.isalpha()==False and has.isalnum()==True:
        jerar.append("106680")
def md5sha1md5pass(has):
    hs='099b8a59795e07c334a696a10c0ebce0'
    if len(has)==len(hs) and has.isdigit()==False and has.isalpha()==False and has.isalnum()==True:
        jerar.append("106700")
def md5sha1md5sha1pass(has):
    hs='06e4af76833da7cc138d90602ef80070'
    if len(has)==len(hs) and has.isdigit()==False and has.isalpha()==False and has.isalnum()==True:
        jerar.append("106720")
def md5strtouppermd5pass(has):
...
def LineageIIC4(has):
    ...
    if len(has)==len(hs) and has.isdigit()==False and has.isalpha()==False and has.isalnum()==True and has[0:2].find('0x')==0:
        jerar.append("107080")
def MD5phpBB3(has):
    hs='$H$9kyOtE8CDqMJ44yfn9PFz2E.L2oVzL1'
    if len(has)==len(hs) and has.isdigit()==False and has.isalpha()==False and has.isalnum()==False and has[0:3].find('$H$')==0:
        jerar.append("107040")
def MD5Unix(has):
    hs='$1$cTuJH0Ju$1J8rI.mJReeMvpKUZbSlY/'
    if len(has)==len(hs) and has.isdigit()==False and has.isalpha()==False and has.isalnum()==False and has[0:3].find('$1$')==0:
        jerar.append("107060")
def MD5Wordpress(has):
    hs='$P$BiTOhOj3ukMgCci2juN0HRbCdDRqeh.'
    if len(has)==len(hs) and has.isdigit()==False and has.isalpha()==False and has.isalnum()==False and has[0:3].find('$P$')==0:
        jerar.append("107020")

def MD5APR(has):
    hs='$apr1$qAUKoKlG$3LuCncByN76eLxZAh/Ldr1'
    if len(has)==len(hs) and has.isdigit()==False and has.isalpha()==False and has[0:4].find('$apr')==0:
        jerar.append("108020")
...
def MySQL160bit(has):
    ...
    if len(has)==len(hs) and has.isdigit()==False and has.isalpha()==False and has.isalnum()==False and has[0:1].find('*')==0:
        jerar.append("109060")
def RipeMD160(has):
    hs='dc65552812c66997ea7320ddfb51f5625d74721b'
    if len(has)==len(hs) and has.isdigit()==False and has.isalpha()==False and has.isalnum()==True:
        jerar.append("109120")
def RipeMD160HMAC(has):
...
def Tiger192(has):
    ...
    if len(has)==len(hs) and has.isdigit()==False and has.isalpha()==False and has.isalnum()==True:
        jerar.append("110020")
def Tiger192HMAC(has):
    hs='8e914bb64353d4d29ab680e693272d0bd38023afa3943a41'
    if len(has)==len(hs) and has.isdigit()==False and has.isalpha()==False and has.isalnum()==True:
        jerar.append("110060")

def MD5passsaltjoomla1(has):
    hs='35d1c0d69a2df62be2df13b087343dc9:BeKMviAfcXeTPTlX'
    if len(has)==len(hs) and has.isdigit()==False and has.isalpha()==False and has.isalnum()==False and has[32:33].find(':')==0:
        jerar.append("112020")

def SHA1Django(has):
    hs='sha1$Zion3R$299c3d65a0dcab1fc38421783d64d0ecf4113448'
    if len(has)==len(hs) and has.isdigit()==False and has.isalpha()==False and has.isalnum()==False and has[0:5].find('sha1$')==0:
        jerar.append("113020")
...
def SAM(has):
    ...
    if len(has)==len(hs) and has.isdigit()==False and has.isalpha()==False and has.isalnum()==False and has.islower()==False and has[32:33].find(':')==0:
        jerar.append("116040")

def SHA256Django(has):
    hs='sha256$Zion3R$9e1a08aa28a22dfff722fad7517bae68a55444bb5e2f909d340767cec9acf2c3'
    if len(has)==len(hs) and has.isdigit()==False and has.isalpha()==False and has.isalnum()==False and has[0:6].find('sha256')==0:
        jerar.append("117020")
...
def SHA256s(has):
    ...
    if len(has)==len(hs) and has.isdigit()==False and has.isalpha()==False and has.isalnum()==False and has[0:3].find('$6$')==0:
        jerar.append("120020")

def SHA384Django(has):
    hs='sha384$Zion3R$88cfd5bc332a4af9f09aa33a1593f24eddc01de00b84395765193c3887f4deac46dc723ac14ddeb4d3a9b958816b7bba'
    if len(has)==len(hs) and has.isdigit()==False and has.isalpha()==False and has.isalnum()==False and has[0:6].find('sha384')==0:
